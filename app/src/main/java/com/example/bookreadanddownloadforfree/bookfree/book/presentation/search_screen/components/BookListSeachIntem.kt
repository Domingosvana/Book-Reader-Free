...
fun BookListItemNewSearch(
   ...
   /* Modifier.drawBehind {
        val strokeWidth = 7.dp.toPx() // Converte 7dp para pixels
        val y = size.height - strokeWidth / 2 // Posiciona no fim da altura

        drawLine(
            color = Color.LightGray, // Ou MaterialTheme.colorScheme.outline
            start = Offset(0f, y),
...
@Composable
fun Modifier.bottomBorder(strokeWidth: Dp, color: Color) = transformable(
...
fun BookListItemSearchPreview(){
    BookListItemNewSearch(
        book = Book(
            id = "/works/OL1234567W",
            title = "Dom Casmurro Dom CasmurroDom Casmurro Dom Casmurro",
            authors = listOf("Machado de Assis Dom CasmurroDom CasmurroDom Casmurro"),
